...
gg.km.by.race.exp$plot <- gg.km.by.race$plot + geom_line(data=df_long, aes(x=time, y=y, group=race))
gg.km.by.race.exp
```
...
# KM curve plot for race adding survreg predictions
gg.km.by.race.Weibull$plot <- gg.km.by.race$plot + geom_line(data=df_long, aes(x=time, y=y, group=race))
