...
The estimated hazard ratios for each parameter included in the final CoxPH model are shown in Figure X below. We see that [...]
...
A significant improvement to this analysis would be first splitting the data into a training and testing dataset, in order to better validate the accuracy of the models and correct for potential overfitting of the data.
